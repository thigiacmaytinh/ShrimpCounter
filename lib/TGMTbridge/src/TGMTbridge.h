...
#define cvRectToRect TGMTbridge::CvRectToRectangle
#define RectTocvRect TGMTbridge::RectangleToCvRect
...
public:
	...
	//static array<System::Drawing::Rectangle^>^ TGMTbridge::CvRectsToRectangles(std::vector<cv::Rect> rects);
