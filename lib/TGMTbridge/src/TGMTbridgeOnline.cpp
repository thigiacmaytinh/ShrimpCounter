...
{
	String^ sUrl = TGMTbridge::stdStrToSystemStr(url);
	return TGMTbridge::SystemStr2stdStr(ReadOnlineFile(sUrl));
}
...
{
	String^ sUrl = TGMTbridge::stdStrToSystemStr(url);
	return TGMTbridge::SystemStr2stdStr(SendGETRequest(sUrl));
}