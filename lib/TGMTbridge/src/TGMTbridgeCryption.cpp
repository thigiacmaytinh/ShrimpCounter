...
{
	System::String^ SstrInput = TGMTbridge::stdStrToSystemStr(input);
	System::String^ SstrPassword = TGMTbridge::stdStrToSystemStr(password);
	System::String^ SstrOutput = EncryptStringAES(SstrInput, SstrPassword);
	return TGMTbridge::SystemStr2stdStr(SstrOutput);
}
