...
class TGMTcamera
{
	...
	std::vector<std::thread*> m_threadCaptures;
	std::atomic<bool> m_isRunning = false;
	std::mutex m_mutex;
	bool m_shouldCheckCamera = false;
...
public:
	...
	void AddCamSource(int camID, bool clearExistCam = false);
	void AddCamSource(std::string camLink, bool clearExistCam = false);
};
